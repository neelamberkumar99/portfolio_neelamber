  ...
  const handleSubmit = (e) => {
    ...
    emailjs
      .send(
        ...
        {
          from_name: form.name,
          to_name: "Neelamber Kumar",
          from_email: form.email,
          to_email: "neelamberkumar966@gmail.com",
      ...
      >
        <div className="flex justify-between items-center mb-4">
          ...
          >
            ...
            <span className="font-medium">9199392721</span>
          </a>
        </div>
        ...
        <form ref={formRef} onSubmit={handleSubmit} className="mt-12 flex flex-col gap-8">
          ...
          <label className="flex flex-col">
            ...
            <textarea
              ...
              value={form.message}
              onChange={handleChange}
              placeholder="Hey neelamber, love the website! I'd like to chat about some opportunities you might like! 🎉"
