        ...
        >
          ...
          <div className="mt-10 flex flex-wrap gap-5 justify-center">
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://www.linkedin.com/in/neelamber-kumar-a7205b294/", "_blank")}
            >
              LinkedIn
            </motion.button>
            ...
            <motion.button
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              onClick={() => window.open("https://github.com/neelamberkumar99", "_blank")}
            >
              GitHub
            </motion.button>
          </div>
        ...
        <motion.div variants={fadeIn("left", "spring", 0.5, 0.75)} className="w-full md:w-2/3">
          ...
          >
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.1, 0.75)}>
              ...
              <span>
                I&apos;m a computer science Engineer of 3rd year student with a passion for software development and web development.
              </span>
            </motion.li>
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.2, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🎓</span>
              <span>
                Currently pursuing a Bachelor of Technology in Computer Science Engineering (3rd year), focused on building reliable and scalable software solutions, with a strong interest in problem-solving and developing impactful real-world applications,
            ...
            <motion.li className="flex items-start" variants={fadeIn("up", "spring", 0.3, 0.75)}>
              <span className="mr-4 text-2xl flex-shrink-0">🛠</span>
              <span>
              full-stack development  I&apos;ve  worked on developing scalable web applications, built end-to-end academic and personal projects, and created efficient solutions focused on real-world impact.
              </span>
            </motion.li>
